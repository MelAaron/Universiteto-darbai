...
//        gc.scale(0.975, 0.975);
    ...
    private void baseSuite3(){
        gc.setStroke(Color.YELLOW);
        gc.setLineWidth(1.0);
        gc.strokeLine(0, 0, 0, canvasH/2);
        
        gc.setFill(randomColor(1));
        gc.fillRoundRect(-100, -50, 10, 10, 30, 20);
        gc.setFill(randomColor(1));
        gc.setStroke(Color.DARKMAGENTA);
        gc.setLineWidth(4);
        gc.strokeLine(canvasW/4, 3*canvasH/4, 3*canvasW/4, canvasW/4);
        gc.fillText("MAGIJA", canvasW/4, canvasW/4);
    ...
    public void createControls() {
        ...
        addButton("suite3",   e -> { baseSuite3(); eh = ehSuite3; });
